...
chron_chase_log$behav_count <- log(chron_chase_log$behav_count)
chron_lat_log <- as.data.frame(chronic_list[[2]])
chron_lat_log$behav_count <- log(chron_lat_log$behav_count)
chron_cont_log <- as.data.frame(chronic_list[[3]])
chron_cont_log$behav_count <- log(chron_cont_log$behav_count)
chron_foll_log <- as.data.frame(chronic_list[[4]])
chron_foll_log$behav_count <- log(chron_foll_log$behav_count)
...
plot(simulateResiduals(fittedModel = chrolog_lat_c))
...
chronhi_chase_log$behav_count <- log(chronhi_chase_log$behav_count)
chronhi_lat_log <- as.data.frame(chronhi_list[[2]])
chronhi_lat_log$behav_count <- log(chronhi_lat_log$behav_count)
chronhi_cont_log <- as.data.frame(chronhi_list[[3]])
chronhi_cont_log$behav_count <- log(chronhi_cont_log$behav_count)
...
chrologhi_chase_c %>% emmeans(pairwise ~ treatment)
...
plot(simulateResiduals(fittedModel = acute_lat_c))
plot(simulateResiduals(fittedModel = acute_cont_c))
plot(simulateResiduals(fittedModel = acute_foll_c))
...
#post hoc pairwise comparison of the significant result
acute_lat_c %>% emmeans(pairwise ~ treatment)
...
#checking the assumptions
plot(simulateResiduals(fittedModel = acute_chase_d))
plot(simulateResiduals(fittedModel = acute_lat_d))
plot(simulateResiduals(fittedModel = acute_foll_d))
...
#models of behavior counts across high visibility fluctuations
acutehi_chase_c <- lm(behav_count ~ treatment,
                       data = acutehi_list[[1]])
...
#checking the model assumptions
check_model(acutehi_chase_c)
check_model(acutehi_lat_c)
check_model(acutehi_cont_c)
check_model(acutehi_foll_c)

#analyzing the models
Anova(acutehi_chase_c)
Anova(acutehi_lat_c)
Anova(acutehi_cont_c)
Anova(acutehi_foll_c)

#post hoc pairwise comparison of the significant results
acutehi_lat_c %>% emmeans(pairwise ~ treatment)
...
#checking the model assumptions
check_model(acutehi_chase_d)
check_model(acutehi_lat_d)
check_model(acutehi_foll_d)

#analyzing the models
Anova(acutehi_chase_d)
Anova(acutehi_lat_d)
Anova(acutehi_foll_d)
...
#models of behavior counts across low visibility recordings
acutelo_chase_c <- lm(behav_count ~ treatment,
                       data = acutelo_list[[1]])
acutelo_lat_c <- update(acutelo_chase_c, . ~ ., data = acutelo_list[[2]])
acutelo_cont_c <- update(acutelo_chase_c, . ~ ., data = acutelo_list[[3]])
acutelo_foll_c <- update(acutelo_chase_c, . ~ ., data = acutelo_list[[4]])

#checking the model assumptions
check_model(acutelo_chase_c)
check_model(acutelo_lat_c)
check_model(acutelo_cont_c)
check_model(acutelo_foll_c)
...
#post hoc analysis for significant result
acutelo_foll_c %>% emmeans(pairwise ~ treatment)
...
#checking the model assumptions
check_model(acutelo_chase_d)
check_model(acutelo_lat_d)
check_model(acutelo_foll_d)
...
stir_lat_log$behav_count <- log(stir_lat_log$behav_count)
stir_cont_log <- as.data.frame(stir_list[[3]])
stir_cont_log$behav_count <- log(stir_cont_log$behav_count)
stir_foll_log <- as.data.frame(stir_list[[4]])
stir_foll_log$behav_count <- log(stir_foll_log$behav_count)
...
plot(simulateResiduals(fittedModel = stirlog_foll_c)) #visually seems acceptable
...
#models of behavior counts across high visibility fluctuations
stirhi_chase_c <- lm(behav_count ~ treatment,
                       data = stirhi_list[[1]])
...
#checking the model assumptions
check_model(stirhi_chase_c)
check_model(stirhi_lat_c)
check_model(stirhi_cont_c)
check_model(stirhi_foll_c)
...
#checking the model assumptions
check_model(stirhi_chase_d) #assumptions not met
check_model(stirhi_lat_d) #assumptions not met
check_model(stirhi_foll_d) #assumptions not met
...
stirhi_foll_log <- as.data.frame(stirhi_list[[4]])
stirhi_foll_log$duration_s <- log(stirhi_foll_log$duration_s)

#the transformed models
stirloghi_chase_d <- update(stirhi_chase_d, . ~ ., data = stirhi_chase_log)
stirloghi_lat_d <- update(stirhi_lat_d, . ~ ., data = stirhi_lat_log)
stirloghi_foll_d <- update(stirhi_foll_d, . ~ ., data = stirhi_foll_log)

#checking the assumptions of the transformed models
check_model(stirloghi_chase_d)
check_model(stirloghi_lat_d)
check_model(stirloghi_foll_d)

#analyzing the results
Anova(stirloghi_chase_d)
Anova(stirloghi_lat_d)
Anova(stirloghi_foll_d)
...
#models of behavior counts across low visibility recordings
stirlo_chase_c <- lm(behav_count ~ treatment,
                       data = stirlo_list[[1]])
...
#checking the model assumptions
check_model(stirlo_chase_c)
check_model(stirlo_lat_c)
check_model(stirlo_cont_c)
check_model(stirlo_foll_c)

#analyzing the results
Anova(stirlo_chase_c)
Anova(stirlo_lat_c)
Anova(stirlo_cont_c)
Anova(stirlo_foll_c)
...
#checking the model assumptions
check_model(stirlo_chase_d)
check_model(stirlo_lat_d)
check_model(stirlo_foll_d)
...
#analyzing the results
Anova(nostir_chase_c)
Anova(nolog_lat_c)
Anova(nostir_cont_c)
Anova(nostir_foll_c)

#post hoc pairwise comparison of the significant results
nolog_lat_c %>% emmeans(pairwise ~ treatment)
...
#checking the model assumptions
plot(simulateResiduals(fittedModel = nostir_chase_d))
plot(simulateResiduals(fittedModel = nostir_lat_d))
plot(simulateResiduals(fittedModel = nostir_foll_d))

#analyzing the results
Anova(nostir_chase_d)
Anova(nostir_lat_d)
Anova(nostir_foll_d)
```
...
nostirhi_chase_c <- lm(behav_count ~ treatment,
                       data = nostirhi_list[[1]])
...
#checking the model assumptions
check_model(nostirhi_chase_c)
check_model(nostirhi_lat_c)
check_model(nostirhi_cont_c) #assumptions not met
check_model(nostirhi_foll_c) #assumptions not met

#transforming the data to meet model assumptions
nostirhi_cont_log <- as.data.frame(nostirhi_list[[3]])
nostirhi_cont_log$behav_count <- log(nostirhi_cont_log$behav_count)
nostirhi_foll_log <- as.data.frame(nostirhi_list[[4]])
nostirhi_foll_log$behav_count <- log(nostirhi_foll_log$behav_count)

#the transformed models
nostirloghi_cont_c <- update(nostirhi_cont_c, . ~ ., data = nostirhi_cont_log)
nostirloghi_foll_c <- update(nostirhi_foll_c, . ~ ., data = nostirhi_foll_log)

#checking the assumptions of the transformed models
check_model(nostirloghi_cont_c)
check_model(nostirloghi_foll_c)

#analyzing the results
Anova(nostirhi_chase_c)
Anova(nostirhi_lat_c)
Anova(nostirloghi_cont_c)
Anova(nostirloghi_foll_c)

#post hoc pairwise comparison of the significant result
nostirloghi_foll_c %>% emmeans(pairwise ~ treatment)
...
#checking the model assumptions
check_model(nostirhi_chase_d)
check_model(nostirhi_lat_d) #assumptions not met
check_model(nostirhi_foll_d)
...
#the transformed models
nostirloghi_lat_d <- update(nostirhi_lat_d, . ~ ., data = nostirhi_lat_log)

#checking the transformed model assumptions
check_model(nostirloghi_lat_d)

#analyzing the results
Anova(nostirhi_chase_d)
Anova(nostirloghi_lat_d)
...
#models of behavior counts across low visibility recordings
nostirlo_chase_c <- lm(behav_count ~ treatment,
...
#checking the model assumptions
check_model(nostirlo_chase_c)
check_model(nostirlo_lat_c) #assumptions not met
check_model(nostirlo_cont_c)
check_model(nostirlo_foll_c)

#transforming the data to meet model assumptions
nostirlo_lat_log <- as.data.frame(nostirlo_list[[2]])
nostirlo_lat_log$behav_count <- log(nostirlo_lat_log$behav_count)

#the transformed model
nostirloglo_lat_c <- update(nostirlo_lat_c, . ~ ., data = nostirlo_lat_log)

#checking the transformed model assumptions
check_model(nostirloglo_lat_c)

#analyzing the results
Anova(nostirlo_chase_c)
Anova(nostirloglo_lat_c)
Anova(nostirlo_cont_c)
...
#checking the model assumptions
check_model(nostirlo_chase_d)
check_model(nostirlo_lat_d) #assumptions not met
check_model(nostirlo_foll_d)

#transforming the data to meet model assumptions
nostirlo_lat_log$duration_s <- log(nostirlo_lat_log$duration_s)

#the transformed model
nostirloglo_lat_d <- update(nostirlo_lat_d, . ~ ., data = nostirlo_lat_log)

#checking the transformed model assumptions
check_model(nostirloglo_lat_d)

#analyzing the models
Anova(nostirlo_chase_d)
Anova(nostirloglo_lat_d)
