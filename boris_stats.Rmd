...
#analyzing the results
Anova(d_con_dd_chase)
Anova(d_con_dd_lat_trans)
Anova(d_con_dd_cont_trans)
Anova(d_con_dd_foll)
Anova(d_con_dd_angr)
Anova(d_con_dd_all_trans)
```
...
#transforming the data to meet model assumptions
direct_cd_trans <- direct_claydye
direct_cd_trans[[1]]$duration_s <- log(direct_cd_trans[[1]]$duration_s+1)
direct_cd_trans[[5]]$duration_s <- log(direct_cd_trans[[5]]$duration_s+1)
...
#analyzing the results
Anova(f_con_cd_chase)
Anova(f_con_cd_lat_trans)
Anova(f_con_cd_cont)
Anova(f_con_cd_foll_trans)
Anova(f_con_cd_angr)
Anova(f_con_cd_all)

#post hoc comparisons of the significant results
f_con_cd_cont %>% emmeans(pairwise ~ experiment:time)
f_con_cd_angr %>% emmeans(pairwise ~ experiment:time)
f_con_cd_all %>% emmeans(pairwise ~ experiment:time)
...
#analyzing the results
Anova(f_con_dd_chase)
Anova(f_con_dd_lat_trans)
Anova(f_con_dd_cont)
Anova(f_con_dd_foll)###
Anova(f_con_dd_angr)
Anova(f_con_dd_all)

#post hoc comparisons of significant results
f_con_dd_foll %>% emmeans(pairwise ~ treatment:time)
f_con_dd_foll %>% emmeans(pairwise ~ experiment:time)
```
...
#analyzing the results
Anova(f_dur_dd_chase_trans)
Anova(f_dur_dd_lat)
Anova(f_dur_dd_foll)
Anova(f_dur_dd_angr_trans)
Anova(f_dur_dd_all)

#post hoc comparisons of the significant results
f_dur_dd_angr_trans %>% emmeans(pairwise ~ treatment:time)
f_dur_dd_all %>% emmeans(pairwise ~ treatment)
```