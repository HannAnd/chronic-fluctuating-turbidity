...
write_csv(pair_lm[[1]], "pairwise_claydye_mean_speed.csv")
write_csv(pair_lm[[2]], "pairwise_claydye_max_speed.csv")
write_csv(pair_lm[[3]], "pairwise_claydye_total_distance.csv")
write_csv(pair_lm[[4]], "pairwise_dyedye_mean_speed.csv")
```
...
#post hoc pairwise comparisons of the significant results
claydye_speed %>% emmeans(pairwise ~ treatment)
...
claydye_dist %>% emmeans(pairwise ~ treatment)
