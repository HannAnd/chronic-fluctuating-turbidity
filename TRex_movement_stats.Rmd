...
pair_lm_col <- do.call(rbind, pair_lm)
pair_lm_col <- pair_lm %>%
...
write_csv(pair_lm[[1]], "direct_pairwise_claydye_mean_speed.csv")
write_csv(pair_lm[[2]], "direct_pairwise_claydye_max_speed.csv")
write_csv(pair_lm[[3]], "direct_pairwise_claydye_total_distance.csv")
write_csv(pair_lm[[4]], "direct_pairwise_dyedye_mean_speed.csv")
```
...
pair_lmm_coll <- do.call(rbind, results_lmm)
pair_lmm_coll <- results_lmm_coll %>%
                    select(experiments, dependent_variable, estimate, SE, df,
                           t.ratio, p.value)
...
write_csv(pair_lmm_coll, "full_pairwise_comparison_movement_LMMs.csv")
