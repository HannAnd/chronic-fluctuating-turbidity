...
#mean shoal area
claydye_shoal <- lm(shoal_area ~ treatment*experiment*time, data = full_claydye)
#mean neighbor distance
...
trans_claydye_shoal %>% emmeans(pairwise ~ treatment:experiment)
claydye_pol %>% emmeans(pairwise ~ treatment:experiment)
...
#checking the model assumptions
plot(dyedye_shoal) #assumptions not met
plot(dyedye_neigh)
plot(dyedye_pol)

#transforming the data to meet model assumptions
trans_full_dyedye <- full_dyedye
trans_full_dyedye$shoal_area <- log(trans_full_dyedye$shoal_area)

#the transformed model
trans_dyedye_shoal <- update(dyedye_shoal, . ~ ., data = trans_full_dyedye)

#checking the transformed model assumptions
plot(trans_dyedye_shoal)

#analyzing the models
Anova(trans_dyedye_shoal)
Anova(dyedye_neigh)
Anova(dyedye_pol)

#post hoc pairwise comparisons of the significant result
trans_d_claydye_shoal %>% emmeans(pairwise ~ treatment)
```