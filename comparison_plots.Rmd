...
claydye_boris_agg$recording <- as.character(claydye_boris_agg$recording)
dyedye_boris_all$recording <- as.character(dyedye_boris_all$recording)
dyedye_boris_agg$recording <- as.character(dyedye_boris_agg$recording)
claydye_boris_all$flux_level <- claydye_boris_all$recording %>%
                                fct_collapse(low = c("1", "3"),
                                             high = c("2", "4"))
claydye_boris_agg$flux_level <- claydye_boris_agg$recording %>%
                                fct_collapse(low = c("1", "3"),
                                             high = c("2", "4"))
dyedye_boris_all$flux_level <- dyedye_boris_all$recording %>%
                               fct_collapse(low = c("1", "3"),
                                            high = c("2", "4"))
dyedye_boris_agg$flux_level <- dyedye_boris_agg$recording %>%
                               fct_collapse(low = c("1", "3"),
                                            high = c("2", "4"))
```
...
c_dirnum_foll <- claydye_boris_all %>%
                 ...
                 ylim(0,45) +
                 theme_classic()
#all aggressive behaviors aggregated
c_dirnum_agg <- claydye_boris_agg %>%
                filter(recording == 4) %>%
                ...
                labs(fill = "Experiment:Treatment") +
                xlab("Treatments") +
                ylab("Total Number of Aggressive Behaviors") +
                scale_fill_manual(values = 
                                c("slategray1", "snow", "wheat1",
                                  "snow3", "wheat4", "snow4")) +
                ylim(0,220) +
...
c_dirnum_all <- claydye_boris_agg %>%
                filter(recording == 4) %>%
                filter(behavior == "all") %>%
                mutate(treatment = fct_relevel(treatment,
                                               "clear", "stable", "flux")) %>%
                ...
                labs(fill = "Experiment:Treatment") +
                xlab("Treatments") +
                ylab("Total Number of Behaviors") +
                scale_fill_manual(values = 
                                c("slategray1", "snow", "wheat1",
                                  "snow3", "wheat4", "snow4")) +
                ylim(0,300) +
...
c_dirsec_foll <- claydye_boris_all %>%
                 ...
                 geom_boxplot() +
                 labs(fill = "Experiment:Treatment") +
                 xlab("Treatments") + ylab("Mean Duration of Follows (s)") +
                 scale_fill_manual(values = 
                                c("slategray1", "snow", "wheat1",
                                  "snow3", "wheat4", "snow4")) +
                 ylim(0,8.8) +
...
c_dirsec_agg <- claydye_boris_agg %>%
                filter(recording == 4) %>%
                filter(behavior == "all_aggressive") %>%
                mutate(treatment = fct_relevel(treatment,
                                               "clear", "stable", "flux")) %>%
                ...
                theme_classic()
#mean duration of all aggressive behaviors
c_dirsec_all <- claydye_boris_agg %>%
                filter(recording == 4) %>%
                filter(behavior == "all") %>%
                mutate(treatment = fct_relevel(treatment,
                                               "clear", "stable", "flux")) %>%
                ...
                labs(fill = "Experiment:Treatment") +
                xlab("Treatments") +
                ylab("Mean Duration of All Behaviors (s)") +
                scale_fill_manual(values = 
                                  c("slategray1", "snow", "wheat1",
                                    "snow3", "wheat4", "snow4")) +
                ylim(0,5.3) +
...
c_fullnum_foll <- claydye_boris_all %>%
                  ...
                  theme_classic()
#all aggressive behaviors aggregated
c_fullnum_agg <- claydye_boris_agg %>%
                 filter(behavior == "all_aggressive") %>%
                 mutate(treatment = fct_relevel(treatment,
                                                "clear", "stable", "flux")) %>%
                 ggplot(aes(x = flux_level, y = behav_count,
                 ...
                 theme_classic()
#all behaviors aggregated
c_fullnum_all <- claydye_boris_agg %>%
                 filter(behavior == "all") %>%
                 mutate(treatment = fct_relevel(treatment,
                                                "clear", "stable", "flux")) %>%
                 ggplot(aes(x = flux_level, y = behav_count,
...
d_fullnum_foll <- dyedye_boris_all %>%
                  ...
                  theme_classic()
#all aggressive behaviors aggregated
d_fullnum_agg <- dyedye_boris_agg %>%
                 filter(behavior == "all_aggressive") %>%
                 mutate(treatment = fct_relevel(treatment,
                                                "clear", "stable", "flux")) %>%
                 ggplot(aes(x = flux_level, y = behav_count,
                 ...
                 theme_classic()
#all behaviors aggregated
d_fullnum_all <- dyedye_boris_agg %>%
                 filter(behavior == "all") %>%
                 mutate(treatment = fct_relevel(treatment,
                                                "clear", "stable", "flux")) %>%
                 ggplot(aes(x = flux_level, y = behav_count,
...
c_fullsec_foll <- claydye_boris_all %>%
                  ...
                  theme_classic()
#mean duration of all aggressive behaviors
c_fullsec_agg <- claydye_boris_agg %>%
                 filter(behavior == "all_aggressive") %>%
                 mutate(treatment = fct_relevel(treatment,
                                                "clear", "stable", "flux")) %>%
                 ggplot(aes(x = flux_level, y = duration_s,
                 ...
                 theme_classic()
#mean duration of all aggressive behaviors
c_fullsec_all <- claydye_boris_agg %>%
                 filter(behavior == "all") %>%
                 mutate(treatment = fct_relevel(treatment,
                                                "clear", "stable", "flux")) %>%
                 ggplot(aes(x = flux_level, y = duration_s,
...
d_fullsec_foll <- dyedye_boris_all %>%
                  ...
                  theme_classic()
#mean duration of all aggressive behaviors
d_fullsec_agg <- dyedye_boris_agg %>%
                 filter(behavior == "all_aggressive") %>%
                 mutate(treatment = fct_relevel(treatment,
                                                "clear", "stable", "flux")) %>%
                 ggplot(aes(x = flux_level, y = duration_s,
                 ...
                 theme_classic()
#mean duration of all aggressive behaviors
d_fullsec_all <- dyedye_boris_agg %>%
                 filter(behavior == "all") %>%
                 mutate(treatment = fct_relevel(treatment,
                                                "clear", "stable", "flux")) %>%
                 ggplot(aes(x = flux_level, y = duration_s,
